...
from app.schemas.tasks_schemas import TaskCreate, TaskResponse, TaskUpdate
...
class TasksService:
    ...
    def get_all_tasks(self) -> list[TaskResponse]:
        ...
        result: list[TaskResponse] = [
            TaskResponse.model_validate(task) for task in stmt
        ]
    ...
    def update_task_patch(
        ...
        updated_task: Tasks | None = self.repository.patch_update_task(
            task_id, task_data
        )
        db.session.commit()
